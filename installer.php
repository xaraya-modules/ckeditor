...
class Installer extends InstallerClass
{
    ...
    public function init()
    {
        ...
        # Set up modvars
        #
        //$this->mod()->setVar('itemsperpage', 20);
        //$this->mod()->setVar('useModuleAlias',0);
        //$this->mod()->setVar('aliasname','CKEditor');
        //$this->mod()->setVar('defaultmastertable','ckeditor_ckeditor');
        ...
        $this->mod()->setVar('PGRFileManager_allowedExtensions', 'pdf, txt, rtf, jpg, gif, jpeg, png');
        $this->mod()->setVar('PGRFileManager_imagesExtensions', 'jpg, gif, jpeg, png, bmp');
        $this->mod()->setVar('PGRFileManager_fileMaxSize', 1024 * 1024 * 10);
        $this->mod()->setVar('PGRFileManager_imageMaxHeight', 724);
